...
class ColorUtilTest {
	...
	void testCalculateDeltaE2000() throws DeltaE2000CalculationException {
		...
		Testing.assertEquals(new BigDecimal("1.558"), ColorUtil.calculateDeltaE2000(color1, color2), DELTA, MC);
		
		color1 = new ColorLab("40.65", "7.39", "-21.43");
		color2 = new ColorLab("41", "7", "-22");
		Testing.assertEquals(new BigDecimal("0.617"), ColorUtil.calculateDeltaE2000(color1, color2), DELTA, MC);
		
		color1 = new ColorLab("80.72", "-3.89", "36.85");
		color2 = new ColorLab("80.3", "-1.8", "34.2");
		Testing.assertEquals(new BigDecimal("1.802"), ColorUtil.calculateDeltaE2000(color1, color2), DELTA, MC);
		
		color1 = new ColorLab("36.23", "1.41", "4.48");
		color2 = new ColorLab("0", "0", "0");
		Testing.assertEquals(new BigDecimal("24.986"), ColorUtil.calculateDeltaE2000(color1, color2), DELTA, MC);

		color1 = new ColorLab("75.61", "0.73", "4.84");
		color2 = new ColorLab("0", "0", "0");
		Testing.assertEquals(new BigDecimal("64.682"), ColorUtil.calculateDeltaE2000(color1, color2), DELTA, MC);
		
		color1 = new ColorLab("57.02", "-22.23", "-29.89");
		color2 = new ColorLab("57", "-23", "-27");
		Testing.assertEquals(new BigDecimal("1.437"), ColorUtil.calculateDeltaE2000(color1, color2), DELTA, MC);

		color1 = new ColorLab("62.48", "1.56", "4.18");
		color2 = new ColorLab("0", "0", "0");
		Testing.assertEquals(new BigDecimal("49.243"), ColorUtil.calculateDeltaE2000(color1, color2), DELTA, MC);
		
		color1 = new ColorLab("53.94", "45.5", "0.53");
		color2 = new ColorLab("54", "44", "-2");
		Testing.assertEquals(new BigDecimal("1.430"), ColorUtil.calculateDeltaE2000(color1, color2), DELTA, MC);
		
		color1 = new ColorLab("61.31", "0.15", "3.45");
		color2 = new ColorLab("58.6", "0.6", "4");
		Testing.assertEquals(new BigDecimal("2.513"), ColorUtil.calculateDeltaE2000(color1, color2), DELTA, MC);
		
		color1 = new ColorLab("79.35", "-4.04", "61.3");
		color2 = new ColorLab("78", "-3", "58");
		Testing.assertEquals(new BigDecimal("1.418"), ColorUtil.calculateDeltaE2000(color1, color2), DELTA, MC);

		color1 = new ColorLab("51.81", "1.71", "3.13");
		color2 = new ColorLab("0", "0", "0");
		Testing.assertEquals(new BigDecimal("38.405"), ColorUtil.calculateDeltaE2000(color1, color2), DELTA, MC);
		
		color1 = new ColorLab("82.63", "-0.58", "3.35");
		color2 = new ColorLab("80", "0.01", "0.01");
		Testing.assertEquals(new BigDecimal("3.674"), ColorUtil.calculateDeltaE2000(color1, color2), DELTA, MC);
		
		color1 = new ColorLab("35.61", "1.3", "2.35");
		color2 = new ColorLab("38", "0.01", "0.01");
		Testing.assertEquals(new BigDecimal("3.481"), ColorUtil.calculateDeltaE2000(color1, color2), DELTA, MC);
	}
	...
	void testCalculateDeltaE2000_neutrality() throws DeltaE2000CalculationException {
		...
		BigDecimal dE = ColorUtil.calculateDeltaE2000(color, color);
	...
	void testCalculateDeltaE2000_associativity() throws DeltaE2000CalculationException {
		...
		BigDecimal dE12 = ColorUtil.calculateDeltaE2000(color1, color2);
		BigDecimal dE21 = ColorUtil.calculateDeltaE2000(color2, color1);
