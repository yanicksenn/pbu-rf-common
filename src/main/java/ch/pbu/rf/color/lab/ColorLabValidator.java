...
public class ColorLabValidator {
	...
	public static final long L_MIN = 0;
	public static final long L_MAX = 100;
	public static final long A_MIN = -170;
	public static final long A_MAX = 100;
	public static final long B_MIN = -100;
	public static final long B_MAX = 150;
}
